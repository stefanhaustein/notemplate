...
NoTemplate.js provides only a single function `element()`. Use nested `element()` calls to build a DOM tree in pure JS in a clean and safe manner without any special syntax, compiler or preprocessor:
